...
/// <summary>
/// As a base class, it implements the required attributes and behaviors of commands repositories
/// of aggregate roots.
/// </summary>
/// <typeparam name="TRoot">Type of the aggregate root.</typeparam>
public abstract class AggregatesCommandRepositoryBase<TRoot>
    : CommandsRepositoryBase<TRoot>
    where TRoot : class, IAggregateRoot
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AggregatesCommandRepositoryBase{TRoot}"/>
    /// class.
    /// </summary>
    /// <inheritdoc/>
    protected AggregatesCommandRepositoryBase(
