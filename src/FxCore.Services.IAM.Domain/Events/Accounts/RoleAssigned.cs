...
/// <summary>
/// Defines the event that is raised when a role has assigned to an account.
/// </summary>
public sealed record RoleAssigned : DomainEventBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RoleAssigned"/> class.
    /// </summary>
