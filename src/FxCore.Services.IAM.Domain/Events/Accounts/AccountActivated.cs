...
/// </summary>
public sealed record AccountActivated : DomainEventBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AccountActivated"/> class.
    /// </summary>
    /// <param name="dependencies">See <see cref="IEventDependenciesProvider"/>.</param>
    /// <param name="accountKey">See <see cref="AccountKey"/>.</param>
    public AccountActivated(IEventDependenciesProvider dependencies, AccountKey accountKey)
        : base(dependencies)
    {
