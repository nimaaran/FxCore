...
/// <summary>
/// Defines the event that is raised when an account authentication failed.
/// </summary>
public record class AuthenticationFailed : DomainEventBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AuthenticationFailed"/> class.
    /// </summary>
